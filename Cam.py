...
while True:
    ...
    # Draw the X and Y axis lines (center of the screen)
    #cv2.line(frame, (frame_width // 2, 0), (frame_width // 2, frame_height), (255, 255, 255), 2)  # Vertical center line
    #cv2.line(frame, (0, frame_height // 2), (frame_width, frame_height // 2), (255, 255, 255), 2)  # Horizontal center line
